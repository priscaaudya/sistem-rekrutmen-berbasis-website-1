                                ...
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <div class="data-tables datatable-dark">
                                         <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
                                            ...
                                            <?php 
                                            $job1=mysqli_query($conn,"SELECT * from pendaftaran p, lowongan l where p.idjob=l.id and aksi='0' order by id_pelamar DESC");
                                            $no=1;
                                            while($p=mysqli_fetch_array($job1)){
                                                ...
                                                <tr>
                                                    <form action="index.php" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <td align="center"> <form action="index.php" method="post" enctype="multipart/form-data" >
                                                            <a href="dpelamar.php?id_pelamar=<?=$id;?>" class="btn btn-info"><i class="fas fa-eye"></i></a>
                                            ...
                                            if(isset($_POST["hapus"])){
                                                    $ids = $_POST['ids'];
                                                    $hapusin = mysqli_query($conn,"delete from pendaftaran where id_pelamar='$ids'");
                                                    if($hapusin){
                                                        unlink($cv);
                                ...
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <div class="data-tables datatable-dark">
                                         <table id="dataTable2" class="display" style="width:100%"><thead class="thead-dark">
                                            ...
                                            <?php 
                                            $job=mysqli_query($conn,"SELECT * from pendaftaran p, lowongan l where p.idjob=l.id and aksi='1' order by id_pelamar DESC");
                                            $no=1;
                                            while($p=mysqli_fetch_array($job)){
                                                ...
                                                <tr>
                                                    <form action="index.php" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <td align="center"> <form action="index.php" method="post" enctype="multipart/form-data" >
                                                            <a href="dpelamar.php?id_pelamar=<?=$id;?>" class="btn btn-info"><i class="fas fa-eye"></i></a>
                                                             <button onclick="return confirm('Anda Yakin Ingin Menghapus Data Ini?');" type="submit" class="btn btn-danger" name="hapus2"\>     <i class="fa fa-trash"></i>
                                                             </button>
                                                        </td>
                                                    </form>
                                                </tr>
