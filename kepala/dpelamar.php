				...
				<div class="row mt-5 mb-5">
					<div class="col-12">
						<div class="card">
							<div class="card-body">
								...
								<div class="formulir">
									...
									<div class="form-group pull-right">
										<input type="submit" data-toggle="modal" data-target="#syarat<?php echo $id;?>" class="btn btn-success" value="Seleksi Syarat">
									</div>									
								</div>
								...
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											<h4 class="modal-title">Seleksi Syarat</h4>
										</div>
										<div class="modal-body">
										<form action="dpelamar.php" method="post" enctype="multipart/form-data" >
												<div class="form-group">
													<label>Nama</label>
							...
							$ids = $_POST['ids'];
							$syarat = $_POST['syarat'];
							$simpanin = mysqli_query($conn,"insert into seleksi values('', '$ids', '$syarat')");
								if($simpanin){
									...
									echo "<script>location='pelamar.php'</script>";
								}
							};							
							?>
							</div>
