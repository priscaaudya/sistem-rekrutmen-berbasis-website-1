...
<head>
    ...
    <!-- ckeditor -->
    <script type="text/javDESCript" src="assets/ckeditor/ckeditor.js"></script>
</head>
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                    <a href="index.php"><img src="../assets/foto/logoputih.png" alt="logo"></a>
            </div>
            <div class="main-menu">
                ...
                <div class="row mt-5 mb-5">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
									...
									<a href="tlowongan.php" type="button" style="margin-bottom:20px; text-align: center;" class="btn btn-success"><i class="fa fa-plus">   Lowongan</i> </a>
                                </div>
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											<?php 
											$job=mysqli_query($conn,"SELECT * from lowongan where id > 1 and status='Active' order by id DESC");
											$no=1;
											while($p=mysqli_fetch_array($job)){
												...
												<tr>
													<form action="index.php" method="post" enctype="multipart/form-data" >
															...
															<td align="center"> 											
																<a href="dlowongan.php?id=<?=$idjob;?>" class="btn btn-info"><i class="fas fa-eye"></i></a>
																<a href="elowongan.php?id=<?=$idjob;?>" class="btn btn-warning"><i class="fas fa-edit"></i></a>
												...
												<?php 
												if($date_now > $date2){													
													$pindahstatus = "update lowongan set status='Inactive' where id='$idjob'";
													$jalanquery = mysqli_query($conn, $pindahstatus);
													
													if($jalanquery){
														echo "<br><meta http-equiv='refresh' content='1; URL=index.php'> Updating";
													} else {
														echo "<br><meta http-equiv='refresh' content='1; URL=index.php'> Mohon tunggu sebentar";
													}
											...
											if(isset($_POST["hapus"])){
													$idj = $_POST['idj'];													
													$hapusin = mysqli_query($conn,"Delete from lowongan where id='$idj'");
													if($hapusin){
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
									<h2>Lowongan Pekerjaan Tidak Aktif</h2>
                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable2" class="display" style="width:100%"><thead class="thead-dark">
											...
											<?php 
											$job=mysqli_query($conn,"SELECT * from lowongan where id > 1 and status='Inactive' order by id DESC");
											$no=1;
											while($p=mysqli_fetch_array($job)){
													$idjob = $p['id'];
													$date1 = $p['tgl_up'];
												...
												<tr>
													<form action="index.php" method="post" enctype="multipart/form-data" >
                   	 									<input type="hidden" name="idj" value="<?php echo $idjob ?>">
															<td align="center"><?php echo $no++ ?></td>
															<td><img src="<?php echo $gambar ?>" width="100" height="100" \></td>
												...
												if($date_now <= $date2){	
													$pindahstatus = "update lowongan set status='Active' where id='$idjob'";
													$jalanquery = mysqli_query($conn, $pindahstatus);
									...
									<!--
									<a href="exportstkbhn.php" target="_blank" class="btn btn btn-info">Export Data</a>
									-->
                                </div>
                            </div>
                        </div>
