					...
					<div class="col-12">
						<div class="card">
							<div class="card-body">
								...
								<div class="formulir">
									<div class="foto" data-aos="fade-center" style="height: 400px; width: 400px;">
										<img src="<?php echo $gambar ?>" class="form-control">
									</div> 
									<div class="form-group">
										<label>Posisi</label>
										<a type="text" class="form-control"><?php echo $namajob ?> </a>
									</div>
									<div class="form-group">
										<label>Kualifikasi</label>
										<a type="text" class="form-control"><?php echo $kualifikasi?> </a>
									</div>
									<div class="form-group">
										<label>Tanggal Berakhir</label>
										<a type="datetime" class="form-control"><?php echo $date2 ?> </a>
									</div>
									<div class="form-group">
										<label>Tanggal Pengumuman</label>
										<a type="datetime" class="form-control"><?php echo $date3 ?> </a>
									</div>
									<div class="form-group">
										<label>Tanggal Upload</label>
										<a type="datetime" class="form-control"><?php echo $date1 ?> </a>
									</div>									
								</div>
							</div>
							<?php
