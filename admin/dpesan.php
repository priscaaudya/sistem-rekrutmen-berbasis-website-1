					...
					<div class="col-12">
						<div class="card">
							<div class="card-body">
								<?php 
  								$getid = $_GET['id'];
								$psn=mysqli_query($conn,"SELECT * from pesan where id >= 1 and id=$getid");
								while($p=mysqli_fetch_array($psn)){
                                        $id = $p['id'];
                                        $nama = $p['nama'];
                                        $email = $p['email']; 
                                        $subjek = $p['subjek'];
								...
								<div class="formulir">
									<div class="form-group">
										<label>Nama</label>
										<a type="text" class="form-control"><?php echo $nama ?>" </a>
									</div>
									<div class="form-group">
										<label>Email</label>
										<a type="text" class="form-control"><?php echo $email ?>" </a>
									<div class="form-group">
										<label>Subjek</label>
										<a type="text" class="form-control"><?php echo $subjek ?>" </a>
									</div>
									<div class="form-group">
										<label>Pesan</label>
										<a type="text" class="form-control"><?php echo $pesan ?>" </a>
									</div>
									<div class="form-group">
										<label>Tanggal Kirim</label>
										<a type="datetime" class="form-control"><?php echo $tanggal ?>" </a>
									</div>	
								</div>
							</div>
							<?php
