					...
					<div class="col-12">
						<div class="card">
							<div class="card-body">
								...
								<div class="formulir">
									<form action="belowo.php" method="post" enctype="multipart/form-data" >
...
<!--									<div class="form-group">
											<label>Gambar</label>
											<input name="img" type="file" class="form-control" value="<?php echo $gambar ?>" required>			
										<div> -->
							...
							$simpanin = mysqli_query($conn,"update lowongan set nama_job='$editjob', kualifikasi='$editreq', close_date='$editdate', tgl_pgm='$editdate2' where id='$idj'");
								if($simpanin){
