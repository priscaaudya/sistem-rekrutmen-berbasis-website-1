                                ...
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											<?php 
											$psn=mysqli_query($conn,"SELECT * from pesan where id >= 1 order by id DESC");
											$no=1;
											while($p=mysqli_fetch_array($psn)){
                                                ...
                                                <tr>
													...
													<form action="pesan.php" method="post" enctype="multipart/form-data" >
                   	 									<input type="hidden" name="idps" value="<?php echo $id ?>">
		                                                    <td align="center"><?php echo $no++ ?></td>
		                                                    <td><?php echo $nama ?></td>
		                                                    <td><?php echo $subjek ?></td>
		                                                    <td align="center"><?php echo $tanggal ?></td>
                                                            <td align="center">
                                                                <a href="dpesan.php?id=<?=$id;?>" class="btn btn-info"><i class="fas fa-eye"></i></a>
											...
											if(isset($_POST["hapus"])){
												    $idps = $_POST['idps'];
													$hapusin = mysqli_query($conn,"delete from pesan where id='$idps'");
													if($hapusin){
